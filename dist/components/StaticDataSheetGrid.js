...
exports.StaticDataSheetGrid = react_2.default.forwardRef((_a, ref) => {
    var { columns, gutterColumn, addRowsComponent, createRow, duplicateRow, style, rowKey, onFocus, onBlur, onActiveCellChange, onSelectionChange, rowClassName, rowHeight } = _a, rest = __rest(_a, ["columns", "gutterColumn", "addRowsComponent", "createRow", "duplicateRow", "style", "rowKey", "onFocus", "onBlur", "onActiveCellChange", "onSelectionChange", "rowClassName", "rowHeight"]);
