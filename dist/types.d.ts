...
export type SelectRowsHandler = (rowSelection: string[] | ((prev: string[]) => string[])) => void;
 ...
 */
export type OperationResult<T> = T | ({
    $operationValue?: Record<string, any>;
} & T);
export type Column<T, C, PasteValue> = {
    ...
    onCellKeyDown?: (opt: {
        ...
        columnId?: string;
        isActive: boolean;
    } & CellHandlersProps<T>, e: React.KeyboardEvent) => void;
    disableEditing: boolean;
    disablePadding: boolean;
    sticky?: 'left' | 'right';
    contextMenuComponent?: ContextMenuType;
};
export type ContextMenuType = (props: ContextMenuComponentProps) => React.ReactElement<any> | null;
...
export type DataSheetGridProps<T> = {
    ...
    headerRowHeight?: number;
    addRowsComponent?: ((props: AddRowsComponentProps) => React.ReactElement<any> | null) | false;
    createRow?: () => T;
    duplicateRow?: (opts: {
        rowData: T;
        rowIndex: number;
    ...
    contextMenuComponent?: (props: ContextMenuComponentProps) => React.ReactElement<any> | null;
    onFocus?: (opts: {
        cell: CellWithId;
    }) => void;
    onBlur?: (opts: {
    ...
    rowSelection?: string[];
    onRowSelectionChange?: ((rowSelection: string[] | ((prev: string[]) => string[])) => void) | undefined;
...
export type TableCallbackProps = {
    ...
    setColumnVisibilityModel: (columnVisibilityModel: ColumnVisibilityModel) => void;
    getRowId: (rowIndex: number) => React.Key;
